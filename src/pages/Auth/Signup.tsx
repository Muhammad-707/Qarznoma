          ...
          <div className="absolute inset-0 flex flex-col justify-between w-full h-full pointer-events-none">
            ...
            <div className="flex justify-between items-end w-full">
              ...
              <div className="bg-zinc-950/60 border border-white/5 p-4 rounded-2xl flex flex-col items-start space-y-2 backdrop-blur-md w-[150px] text-left">
                <span className="text-[8px] font-black text-amber-500 uppercase tracking-widest">System Logs</span>
                <div className="relative w-full h-14 flex items-center justify-center overflow-visible">
        ...
        <div className="w-full max-w-[430px] flex flex-col space-y-6 mx-auto">
          ...
          <form onSubmit={formik.handleSubmit} className="flex flex-col space-y-4">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="flex flex-col space-y-1.5 text-left">
                ...
                {formik.touched.firstName && formik.errors.firstName ? (
                  <span className="text-[10px] text-rose-500 font-bold ml-1">{formik.errors.firstName}</span>
                ) : null}
              </div>
              <div className="flex flex-col space-y-1.5 text-left">
                <label className="text-[10px] font-extrabold uppercase tracking-widest text-zinc-500 dark:text-zinc-400 ml-1">
                ...
                {formik.touched.lastName && formik.errors.lastName ? (
                  <span className="text-[10px] text-rose-500 font-bold ml-1">{formik.errors.lastName}</span>
                ) : null}
              </div>
            </div>
            <div className="flex flex-col space-y-1.5 text-left">
            ...
            <div className="flex flex-col space-y-1.5 text-left">
              ...
              <div className="relative group">
                ...
                <button
                  ...
                  className="absolute inset-y-0 right-0 pr-3.5 flex items-center text-muted-foreground hover:text-foreground active:scale-95 transition-transform"
                >
                  {showConfirmPassword ? <Eye className="h-4 w-4 text-blue-500 animate-pulse" /> : <EyeOff className="h-4 w-4" />}
                </button>
              </div>
              {formik.touched.confirmPassword && formik.errors.confirmPassword ? (
                <span className="text-[10px] text-rose-500 font-bold ml-1">{formik.errors.confirmPassword}</span>
              ) : null}
            </div>
            {errorText && (
            ...
            <Button
              type="submit"
              disabled={isLoading}
              className="w-full relative rounded-2xl h-11 text-xs font-bold text-white transition-all duration-300 hover:scale-[1.02] hover:shadow-[0_4px_25px_rgba(99,102,241,0.35)] active:scale-[0.98] bg-gradient-to-r from-[#2563eb] via-[#7c3aed] to-[#db2777] border-0 mt-6 flex items-center justify-center gap-2 group disabled:opacity-50"
            >
          ...
          <div className="flex items-center justify-center space-x-1.5 text-xs text-zinc-500 font-semibold">
            ...
            <Link to="/login" className="font-extrabold text-indigo-500 hover:underline">
              {t("auth.loginLink")}
            </Link>
          </div>
        </div>
